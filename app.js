...
let dev_db_url = 'mongodb://localhost:27017/dd'; 
...
app.get('/', function (req, res) {
  ...
  // console.log(mingleInstance.configInstance);
  res.send('Hello World! DD PROJECT');
});
...
//     jwt.verify(token, 'ddproject', (err, decoded) => {
//       if (err) {
